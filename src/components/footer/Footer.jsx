...
const Footer = () => {
  return (
    <div className="bg-[#244D3F]">
      <footer className="footer footer-horizontal footer-center text-primary-content w-9/12 mx-auto  p-10">
        <aside>
      ...
      <footer className="flex flex-col-reverse md:flex-row justify-between items-center gap-10 text-gray-400 text-sm border-gray-500 border-t p-10 w-9/12 mx-auto">
